...
namespace EchoServer.ScreenConsole.Tests
{
    public class RenderMapTests
    {
        ...
        public RenderMapTests()
        {
            _map = new RenderMap(5);
        ...
        [Fact]
        public void Renderables_are_added_to_the_bottom_of_the_map()
        {
            ...
            Assert.Equal(r1, _map.Renderables[0]);
            Assert.Equal(r2, _map.Renderables[1]);
        }
        ...
        [Fact]
        public void Old_renderables_are_removed_from_the_top()
        {
            var r1 = new DummyRenderable("r1", _renderer);
            var r2 = new DummyRenderable("r2", _renderer);
            var r3 = new DummyRenderable("r3", _renderer);
            ...
            Assert.Equal(r6, _map.Renderables[4]);
        }
        ...
        public void Map_keeps_track_of_renderable_indeces()
        {
            ...
            Assert.Equal(1, _map.GetRenderMapIndex(r3));
        }
